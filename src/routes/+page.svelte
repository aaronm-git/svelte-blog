		...
		<section class="post">
			<header class="post-header">
				<img
					...
					class="post-avatar"
					src="https://purecss.io/img/common/tilo-avatar.png"
				/>
		...
		<section class="post">
			<header class="post-header">
				<img
					...
					class="post-avatar"
					src="https://purecss.io/img/common/ericf-avatar.png"
				/>

				<h2 class="post-title">Everything You Need to Know About Node.js</h2>

				<p class="post-meta">
					By <a class="post-author" href="#">Eric Ferraiuolo</a> under
		...
		<section class="post">
			<header class="post-header">
				<img
					...
					class="post-avatar"
					src="https://purecss.io/img/common/reid-avatar.png"
				/>

				<h2 class="post-title">Photos from CSSConf and JSConf</h2>

				<p class="post-meta">
					By <a class="post-author" href="#">Reid Burke</a> under
